...
<?php if ($this->getParam('responsive', 1)): ?>
    ...
    <style type="text/stylesheet" nonce="<?= $_SERVER["HTTP_CSP_NONCE"] ?>">
        @-webkit-viewport {
            width: device-width;
        }
    ...
    <script src="<?= JUri::base() ?>/components/com_apiportal/assets/js/system-messages.js"></script>
...
<!--[if lt IE 9]>
<script type="text/javascript" src="<?php echo JURI::base(true) . 'templates/purity_iii/js/html5.js';?>"></script>
